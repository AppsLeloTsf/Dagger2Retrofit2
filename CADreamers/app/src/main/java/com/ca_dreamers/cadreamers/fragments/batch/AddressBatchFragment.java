...
import com.ca_dreamers.cadreamers.adapter.address.AdapterAddressBatch;
...
public class AddressBatchFragment extends Fragment {
        ...
        try {
            ...
            userCall.enqueue(new Callback<ModelAddress>() {
                ...
                public void onResponse(@NonNull Call<ModelAddress> call, @NonNull Response<ModelAddress> response) {
                    ...
                    AdapterAddressBatch adapterAddress = new AdapterAddressBatch(modelAddress.getData(), getContext(), strId, strPrice);
