...
public class CustomViewPager extends ViewGroup {
     ...
     *
     * @param cross_x the number of pixels to scroll by on the X axis
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE && (ii = infoForChild(child)) != null) {
                ...
                if (DEBUG) Log.v(TAG, "Positioning #" + i + " " + child + " f=" + ii.object
                        ...
                        + "cross_x" + child.getMeasuredHeight());
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                if (DEBUG)
                    Log.v(TAG, "Moved cross_x to " + x + "," + y + " diff=" + xDiff + "," + yDiff);
     ...
     * @param cross_x      X coordinate of the active touch point
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            switch (event.getKeyCode()) {
                ...
                case KeyEvent.KEYCODE_TAB:
                    ///////// RAHUL  KeyEventCompat not found
