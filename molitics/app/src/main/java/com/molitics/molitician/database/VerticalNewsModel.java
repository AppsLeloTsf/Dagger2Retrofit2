...
/**
 * Created by Rahul on 2/17/2017.
 */

public class VerticalNewsModel extends RealmObject {
    ...
    public RealmList<LocalNewsTagLeaderModelDemo> getLocalNewsLeaderModels() {
        return localNewsLeaderModels;
    }

    public void setLocalNewsLeaderModels(RealmList<LocalNewsTagLeaderModelDemo> localNewsLeaderModels) {
        this.localNewsLeaderModels = localNewsLeaderModels;
    }
