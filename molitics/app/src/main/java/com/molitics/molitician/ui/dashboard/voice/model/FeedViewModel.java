...
public class FeedViewModel extends BaseViewModel<VoiceViewNavigation> {
    String TAG = FeedViewModel.class.getSimpleName();
    ...
    public void setFeedData(FeedModel voiceAllModel) {
        uploadedCount = 1;
