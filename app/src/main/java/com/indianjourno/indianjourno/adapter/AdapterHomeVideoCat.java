...
public class AdapterHomeVideoCat extends RecyclerView.Adapter<AdapterHomeVideoCat.MenuCategoryViewHolder>{

    private Context tContext;
    private List<VideoCategory> tModels;
    public AdapterHomeVideoCat(Context tContext, List<VideoCategory> tModels) {
    ...
    public MenuCategoryViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.frag_home_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MenuCategoryViewHolder menuCategoryViewHolder, final int i) {
        ...
        Glide.with(tContext)
                .load(Constant.VIDEO_IMG_URL_IMAGES+strImgUrl)
    ...
    public class MenuCategoryViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.ivFragHome)
        protected ImageView ivNewsImage;
        @BindView(R.id.tvFragHome)
